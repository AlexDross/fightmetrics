...
console.log(`\nRerun complete: ${rerun} recomputed, ${skipped} skipped (before ${CUTOFF}), ${notFound} fighters not found`);
...
console.log(`\nSpot-check (first 3 recomputed entries):`);
updated
  .filter((e) => (e.eventDate ?? '') >= CUTOFF && e.projectedFinish != null)
  .slice(0, 3)
  .forEach((e) => {
