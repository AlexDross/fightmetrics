...
const MODEL = {
  ...
  W_OD: null,
  // Sigmoid probability mapping: p = sigmoid(a * composite + b)
  // Parameters require refit on cleaned composite/outcome pairs (Sprint 2).
  // Current values are approximate — do not treat as externally calibrated.
  SIGMOID_MAP: { a: 1.609621, b: -0.18753374136521064 },
