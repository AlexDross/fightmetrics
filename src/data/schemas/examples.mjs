...
export const REVIEW_STATE_EXAMPLES = Object.freeze({
  // No `reason` key at all — it belongs to the other two variants.
  notRequired: { status: 'notRequired' },
  pending: { status: 'pending', reason: 'autoGenerated' },
  confirmedWithTime: { status: 'confirmed', reason: 'autoGenerated', confirmedAt: TS },
  // Legacy-only: the UI recorded that an entry was confirmed but never when.
  confirmedLegacyNoTime: { status: 'confirmed', reason: 'autoGenerated', confirmedAt: null },
});
...
export const ENTITY_EXAMPLES = Object.freeze({
  ...
  trackedPositionLegacy: {
    id: T, boutId: B, assessmentId: A, marketSnapshotId: M, origin: 'legacyMigration',
    corner: 'A', stakeUnits: 1, stakeSource: 'defaultedFlat1u', openedAt: TS,
    settlement: SETTLEMENT_EXAMPLES.legacySettledAtNull,
    reviewState: REVIEW_STATE_EXAMPLES.notRequired, notes: null,
  },
  trackedPositionAppCreated: {
    id: T, boutId: B, assessmentId: A, marketSnapshotId: M, origin: 'appCreated',
    corner: 'B', stakeUnits: 2, stakeSource: 'explicit', openedAt: TS,
    settlement: SETTLEMENT_EXAMPLES.wonComputed,
    reviewState: REVIEW_STATE_EXAMPLES.confirmedWithTime, notes: 'closed early',
  },
  // The two legacy positions with no odds on either corner: scored against no
  // market at all, so their financial result must be uncomputable.
  trackedPositionNoMarket: {
    id: T, boutId: B, assessmentId: A, marketSnapshotId: null, origin: 'legacyMigration',
    corner: 'A', stakeUnits: 1, stakeSource: 'defaultedFlat1u', openedAt: TS,
    settlement: SETTLEMENT_EXAMPLES.wonUncomputable,
    reviewState: REVIEW_STATE_EXAMPLES.notRequired, notes: null,
  },
  // An auto-generated entry awaiting review. Statistics exclude only this state.
  trackedPositionPendingReview: {
    id: T, boutId: B, assessmentId: A, marketSnapshotId: M, origin: 'appCreated',
    corner: 'A', stakeUnits: 1, stakeSource: 'explicit', openedAt: TS,
    settlement: SETTLEMENT_EXAMPLES.open,
    reviewState: REVIEW_STATE_EXAMPLES.pending, notes: null,
  },
